...
export declare function toggle<TObject extends object, TKey extends keyof TObject, I = true | false>(object: TObject, path: TKey | [TKey], ...values: [[I]]): I | (I extends falsy ? true : false);
...
export declare function toggle<T, I = true | false>(object: {
    ...
    [index: string]: T;
}, path: number, ...values: [[I]]): I | (I extends falsy ? true : false);
export declare function toggle<T, I = true | false>(object: {
    [index: number]: T;
} | {
    [index: string]: T;

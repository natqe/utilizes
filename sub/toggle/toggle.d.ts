...
export declare function toggle<TObject extends object, TKey extends keyof TObject, I = true | false>(object: TObject, path: TKey | [TKey], values: Array<I>): I | (I extends falsy ? true : false);
...
export declare function toggle<T, I = true | false>(object: {
    ...
    [index: string]: T;
}, path: number, values: Array<I>): I | (I extends falsy ? true : false);
export declare function toggle<T, I = true | false>(object: {
    [index: number]: T;
} | {
    [index: string]: T;
}, path: number, values: Array<I>): typeof values['length'] extends 0 ? boolean : I;
export declare function toggle<I = true | false>(object: any, path: PropertyPath, values: [I]): I | (I extends falsy ? true : false);

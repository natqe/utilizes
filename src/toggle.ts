...
export function toggle<TObject extends object, TKey extends keyof TObject, I = true | false>(object: TObject, path: TKey | [TKey], ...values: [[I]]): I | boolean
...
export function toggle<T, I = true | false>(object: { [index: number]: T } | { [index: string]: T }, path: number, ...values: [[I]]): I | boolean
...
export function toggle<I = true | false>(object, path: PropertyPath, ...values: [[I]]): I | boolean
export function toggle<I = true | false>(object, path: PropertyPath, ...values: [Array<I>]): typeof values[0]['length'] extends 0 ? boolean : I
export function toggle<TObject extends object, TKey extends keyof TObject, I = true | false>(object: TObject, path: TKey | [TKey], ...values: [I]): I | (typeof values[0] extends falsy ? true : false)
...
export function toggle<T, I = true | false>(object: { [index: number]: T } | { [index: string]: T }, path: number, ...values: [I]): I | (typeof values[0] extends falsy ? true : false)
...
export function toggle<I = true | false>(object, path: PropertyPath, ...values: [I]): I | (typeof values[0] extends falsy ? true : false)
...
export function toggle<TObject extends object, TKey extends keyof TObject, T, I = true | false>(
  ...
  ...values: Array<I> | [I] | [Array<I>]):
  typeof values['length'] extends 0 ? boolean : I {
